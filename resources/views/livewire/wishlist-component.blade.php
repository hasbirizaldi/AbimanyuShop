                        ...
                        <div class="product-cart-wrap mb-30">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-price">
                                    <span>Rp. {{ number_format($item->model->regular_price) }}</span>
                                    {{-- <span class="old-price">$245.8</span> --}}
                                </div>
                                <div class="product-action-1 show">

                                    <a aria-label="Remove From Wishlist" class="action-btn hover-up wishlisted" href="#" wire:click.prevent="removeFromWishlist({{ $item->model->id }},'{{ $item->model->name }}',{{ $item->model->regular_price }})"><i class="fi-rs-heart"></i></a>
