                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details', ['slug'=>$fProduct->slug])}}">
                                                <img class="default-img" src="{{asset('assets/imgs/products/'.$fProduct->image) }}" alt="{{ $fProduct->name }}" height="340">
                                                <img class="hover-img" src="{{asset('assets/imgs/products/'.$fProduct->image) }}" alt="{{ $fProduct->name }}"  height="340">
                                            </a>
                                        </div>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-price">
                                            <span>Rp. {{ number_format($fProduct->regular_price) }} </span>
                                            <span class="old-price">Rp. {{ number_format($fProduct->sale_price) }}</span>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{route('product.details', ['slug'=>$fProduct->slug])}}">Lorem ipsum dolor</a></h2>
                                        <div class="rating-result" title="90%">
                                            <span>
                                                <span>90%</span>
                                            </span>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{route('product.details', ['slug'=>$fProduct->slug])}}">Sed tincidunt interdum</a></h2>
                                        <div class="rating-result" title="90%">
                                            <span>
                                                <span>50%</span>
                                            </span>
                    ...
                    <div class="carausel-6-columns" id="carausel-6-columns">
                        ...
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="{{route('product.category', ['slug'=>$tCategory->slug])}}"><img src="{{asset('assets/imgs/categories/'.$tCategory->image) }}" height="200" alt="{{ $tCategory->name }}"></a>
                            </figure>
                            <h5><a href="{{route('product.category', ['slug'=>$tCategory->slug])}}">{{ $tCategory->name }}</a></h5>
                        </div>
                        @endforeach
                    ...
                    <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="{{ route('product.details', ['slug'=>$lProduct->slug]) }}">
                                        <img class="default-img" src="{{asset('assets/imgs/products/'.$lProduct->image) }}" alt="{{ $lProduct->name }}" height="220">
                                        <img class="hover-img" src="{{asset('assets/imgs/products/'.$lProduct->image) }}" alt="{{ $lProduct->name }}" height="220">
                                    </a>
                                </div>
                                <div class="product-action-1">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-price">
                                    <span>Rp. {{ number_format($lProduct->regular_price) }} </span>
                                    <span class="old-price">Rp. {{ number_format($lProduct->sale_price) }}</span>
                                </div>
                            </div>
                        </div>
                        @endforeach
