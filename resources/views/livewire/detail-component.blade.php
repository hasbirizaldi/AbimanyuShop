                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/products/'.$product->image)}}" alt="product image" width="500" height="550">
                                            </figure>
                                            <figure class="border-radius-10">
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">Rp. {{number_format($product->regular_price)}}</span></ins>
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    ...
                                                    <div class="product-price">
                                                        <span>Rp. {{ number_format($rProduct->regular_price) }}</span>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    ...
                                    <p class="price mb-0 mt-5">Rp. {{ number_format($nProduct->regular_price) }}</p>
