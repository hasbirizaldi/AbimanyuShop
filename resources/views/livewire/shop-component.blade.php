                        ...
                        <div class="shop-product-fillter">
                            ...
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{ $pageSize == 'Default Sorting' ? 'active' : ''}}" href="#" wire:click.prevent="changeOrderBy('Default Sorting')">Default Sorting</a></li>
                                            <li><a class="{{ $pageSize == '>Price: Low to High' ? 'active' : ''}}"  wire:click.prevent="changeOrderBy('Price: Low to High')" href="#">Price: Low to High</a></li>
                                            <li><a class="{{ $pageSize == 'Price: High to Low' ? 'active' : ''}}"  wire:click.prevent="changeOrderBy('Price: High to Low')" href="#">Price: High to Low</a></li>
                                            <li><a class="{{ $pageSize == 'Sort By Newness' ? 'active' : ''}}"  wire:click.prevent="changeOrderBy('Sort By Newness')" href="#">Sort By Newness</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-price">
                                            <span>Rp. {{ number_format($product->regular_price) }}</span>
                                        ...
                                        <div class="product-action-1 show">
                                            ...
                                            <a aria-label="Remove From Wishlist" class="action-btn hover-up wishlisted" href="#"  wire:click.prevent="addToWishlist({{ $product->id}}, '{{$product->name}}', {{ $product->regular_price }})"><i class="fi-rs-heart"></i></a>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget price_range range mb-30">
                            <div class="widget-header position-relative mb-20 pb-10">
                                <h5 class="widget-title mb-10">Filler by price</h5>
                                ...
                                <div class="price-filter-inner">
                                    ...
                                    <div class="price_slider_amount">
                                        <div class="label-input">
                                            <span>Range:</span><span class="text-info">Rp. {{ number_format($min_value) }}</span> - <span class="text-info">Rp. {{ number_format($max_value) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
