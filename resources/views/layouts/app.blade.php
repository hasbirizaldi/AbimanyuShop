            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="{{route('home.index')}}"><h3><span class="text-danger">Abi</span><span class="text-secondary">Manyu</span>  <span class="text-success">Shop</span></h3></a>
                ...
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="header-nav d-none d-lg-flex">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="{{asset('shop')}}" alt="menu_banner1">
                                                        <div class="banne_info">
                                                            <h6>10% Off</h6>
                                                            <h4>New Arrival</h4>
                                                            <a href="#">Shop now</a>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    <li><a class="{{ Route::is('/') ? 'active' : '' }}}" href="{{route('home.index')}}">Home </a></li>
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>Toll Free</span> (+62) 85640402997  </p>
                    </div>
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="{{route('shop.cart')}}">
                                    ...
                                    <span class="pro-count white">200</span>
                                </a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>Gombong, Jawa Tengah
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+62 85640402997
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>hasbirizaldi14@gmail.com
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Abimanyu | 2023</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
